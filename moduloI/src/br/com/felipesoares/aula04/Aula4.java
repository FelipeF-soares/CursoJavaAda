...
public class Aula4 {
	public static void main(String[] args) {
	       ...
	       /*for (int numero : lista){
			 ...
			 * 
			 * outraLista.forEach( item -> { String primeiraLetra =
			 * item.substring(0,1).toUpperCase(); String restoDoNome =
			 * item.substring(1,item.length()); String nomeTodo = primeiraLetra +
